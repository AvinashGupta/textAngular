...
(function(){ // encapsulate all variables so they don't become global vars
	...
	*/
	...
	if(ie > 8 || ie === undefined){
		...
		_addCSSRule(topsheet, '.ta-root.focussed .ta-scroll-window.form-control', 'overflow: auto; border-color: #66afe9; outline: 0; -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 8px rgba(102, 175, 233, 0.6);');
		_addCSSRule(topsheet, '.ta-editor.ta-html', "min-height: 300px; height: auto; overflow: auto; font-family: inherit; font-size: 100%;");
		_addCSSRule(topsheet, '.ta-scroll-window .ta-bind', "height: 100%; padding: 6px 12px;");
